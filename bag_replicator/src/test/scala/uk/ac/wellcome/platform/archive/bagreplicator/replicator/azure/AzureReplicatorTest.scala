...
import uk.ac.wellcome.storage.store.azure.{NewAzureStreamStore, NewAzureTypedStore}
...
class AzureReplicatorTest
    extends ReplicatorTestCases[Container, AzureBlobItemLocation, AzureBlobItemLocationPrefix]
    with AzureFixtures {
