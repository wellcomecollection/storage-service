...
import uk.ac.wellcome.platform.archive.bagreplicator.storage.azure.{AzurePrefixTransfer, AzureTransfer}
...
) extends Replicator[S3ObjectSummary,AzureBlobLocation, AzureBlobLocationPrefix] {
