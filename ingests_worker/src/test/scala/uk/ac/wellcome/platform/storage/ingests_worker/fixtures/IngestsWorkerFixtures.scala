    ...
    withFakeMonitoringClient() { implicit monitoringClient =>
      withActorSystem { implicit actorSystem =>
        withMaterializer(actorSystem) { implicit materializer =>
          ...
          val api: IngestsTrackerApi[String, String] = new IngestsTrackerApi[String, String] {

            val callbackNotificationService = new CallbackNotificationService(callbackNotificationMessageSender)
