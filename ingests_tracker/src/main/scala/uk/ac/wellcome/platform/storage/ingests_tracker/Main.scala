...
object Main extends WellcomeTypesafeApp {
  runWithConfig { config: Config =>
    ...
    val callbackNotificationService: CallbackNotificationService[SNSConfig] = new CallbackNotificationService(
    ...
    val updatedIngestsMessageSender: SNSMessageSender = SNSBuilder.buildSNSMessageSender(
      config,
