...
import uk.ac.wellcome.platform.archive.common.ingests.tracker.{BetterIngestTracker, IngestTrackerError}
import uk.ac.wellcome.storage.Version
import uk.ac.wellcome.storage.dynamo.DynamoConfig
import uk.ac.wellcome.storage.store.VersionedStore
import uk.ac.wellcome.storage.store.dynamo.DynamoHashStore

class DynamoIngestTracker(val underlying: VersionedStore[IngestID, Int, Ingest]) extends BetterIngestTracker {
