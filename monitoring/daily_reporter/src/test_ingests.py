...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {
                "status": "failed",
                "events": [{"description": "Detecting bag root failed"}],
            },
            "failed (user error)",
        ),
        ({"status": "failed", "events": []}, "failed (unknown reason)"),
        ...
        (
            {
                ...
                "events": [
                    {
                        "description": "Ingest manually marked as failed by <a.chan@wellcome.ac.uk>"
                    }
                ],
            },
            "failed (known error)",
        ...
        (
            {
                "status": "failed",
                "events": [
                    {"description": "Unpacking failed - Access denied"},
                    {"description": "Callback failed for:"},
                ],
            },
            "failed (user error)",
        ),
