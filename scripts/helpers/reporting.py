...
def get_reporting_client(secrets_client, *, environment, app_name):
    ...
    """
    username = read_secret(secrets_client, id=f"{environment}/indexer/{app_name}/es_username")
    password = read_secret(secrets_client, id=f"{environment}/indexer/{app_name}/es_password")
