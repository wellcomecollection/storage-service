...
aws s3 cp s3://wellcomecollection-platform-infra/miro-migration/index_files.json _cache/index_files.json --profile platform
aws s3 cp s3://wellcomecollection-platform-infra/miro-migration/index_registrations.json _cache/index_registrations.json --profile platform
...
python3 main.py load-index --index-name files -o
python3 main.py load-index --index-name registrations -o
