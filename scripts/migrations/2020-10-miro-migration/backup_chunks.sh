...
python3 main.py save-index --index-name chunks_derivatives -o
...
aws s3 cp _cache/index_chunks_derivatives.json s3://wellcomecollection-platform-infra/miro-migration/index_chunks_derivatives.json --profile platform
