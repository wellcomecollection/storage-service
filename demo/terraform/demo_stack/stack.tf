module "stack" {
  source = "github.com/wellcomecollection/storage-service.git//terraform/modules/stack?ref=19d9a4b"
  ...
  app_containers = {
    ...
    container_tag      = "ref.19d9a4b3d46ede95b7618e91aeca4fffb380848f"
  }
}
