...
import uk.ac.wellcome.platform.archive.common.storage.models.{FileManifest, IngestFailed, IngestStepResult, IngestStepSuccess}
import uk.ac.wellcome.platform.archive.common.storage.services.{ChecksumVerifier, StorageManifestService}
