...
ARCHIVE_FORMAT = os.environ.get("ARCHIVE_FORMAT", "gztar")
...
CACHE_BUCKET = os.environ["BAGGER_CACHE_BUCKET"]
...
DDS_TEXT_INFO = os.getenv("DDS_TEXT_INFO")
DDS_DLCS_COUNTS = os.getenv("DDS_DLCS_COUNTS")
